...
interface MonsterListing extends CardData {
...
export default function MonsterMarketplacePage() {
  ...
  // Card listings state
  const [listings, setListings] = useState<MonsterListing[]>([]);
  ...
  const filteredListings = (items: MonsterListing[]) => {
    const typeFiltered =
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const normalizedListings: MonsterListing[] = Array.isArray(data?.data)
        ...
        console.error('Error fetching monster marketplace data:', error);
    ...
    >
      ...
      <Stack spacing={{ xs: 1.5, sm: 2 }} sx={{ mb: { xs: 3, md: 4 } }}>
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="text.primary">Monster Cards</Typography>
        </Breadcrumbs>
        ...
        >
          <Box>
            ...
            >
              Discover and collect unique monster trading cards from the
              community
            </Typography>
          </Box>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <CardDisplayWrapper card={listing} width="responsive" />
                      </Box>
                    </LazyCardRenderer>
