...
import SequentialPackOpening from './components/SequentialPackOpening';
...
const BoosterClientPage: FC = () => {
  const params = useParams();
  const pack = useMemo(
    () => getPackBySlug((params as { slug?: string })?.slug),
    [params],
  );
            ...
            <CardContent>
              ...
              >
                ...
                <Stack direction="row" spacing={1}>
                  <Button component={Link} href="/booster/packs" variant="text">
                    All Packs
                  </Button>
                  <Button component={Link} href={Routes.Gallery} variant="text">
                    My Collection
                  </Button>
                </Stack>
              </Stack>
...
export default BoosterClientPage;
