    ...
    <Box>
      <ImagesWrapper>
        <PerspectiveWrapper>
          <PerspectiveImg>
            <Image
              src={demoBackgroundImg}
              layout="fill"
              alt="Demo background image layer"
            />
            <NumberText variant="h5">1.</NumberText>
          </PerspectiveImg>
          <PerspectiveImg $translateX={20}>
            <Image src={demoLayer1Img} layout="fill" alt="Demo layer 1 image" />
            <NumberText variant="h5">2.</NumberText>
          </PerspectiveImg>
          <PerspectiveImg $translateX={60}>
            <Image src={demoCardImg} layout="fill" alt="Demo card image" />
            <NumberText variant="h5">3.</NumberText>
          </PerspectiveImg>
          <PerspectiveImg $translateX={100}>
            <Image src={demoLayer2Img} layout="fill" alt="Demo layer 2 image" />
        ...
        />
        <FullImage>
          <Image src={demoFullImg} alt="Demo full card result" />
        </FullImage>
      </ImagesWrapper>
