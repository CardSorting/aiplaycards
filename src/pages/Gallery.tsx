...
import BoosterCardBackSkeleton from '@components/BoosterCardBack/Skeleton';
...
import { GalleryControls, GalleryFilters, GalleryHeader } from '@features/gallery/components';
...
const Gallery: FC = () => {
    ...
    const { page, setPage, total, setTotal, itemsPerPage } =
        usePagination(20);
    ...
    }, [paginatedCards, filteredAndSortedCards.length, page, setPage, setTotal]);
    ...
    if (!user) {
        return (
            <>
                <SEO
                    title="My Collection - Login Required"
                ...
                <Container maxWidth="md" sx={{ py: 8, textAlign: 'center' }}>
                    ...
                    <Button
                        component={Link}
                        to={typeof Routes.Creator === 'string' ? Routes.Creator : '/create'}
                        variant="contained"
                        size="large"
                    >
                        Go to Creator
